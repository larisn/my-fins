...
export default function Fins() {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      fetch(`https://json-server-khaki-sigma.vercel.app/fins/${id}`, {
        method: "GET",
        mode: "cors",
        headers: {
  ...
  function createPriority(fins) {
    ...
    // update priority
    fetch(`https://json-server-khaki-sigma.vercel.app/fins/${fins.id}`, {
      method: "PATCH",
      mode: "cors",
      headers: {
        "Content-type": "application/json",
  ...
  function removePriority(id, cost) {
    ...
    fetch(`https://json-server-khaki-sigma.vercel.app/fins/${finsUpdated.id}`, {
      method: "PATCH",
      mode: "cors",
      headers: {
        "Content-type": "application/json",
